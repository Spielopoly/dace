...
class InsertTileLoadStore(ppl.Pass):
    ...
    def _stage_writes_in_state(self, inner_state: SDFGState, inner_sdfg: SDFG, iter_vars: Tuple[str, ...],
        ...
        for an in [n for n in inner_state.nodes() if isinstance(n, AccessNode)]:
            ...
            # Stage direct tile-to-output copies before the in-place read gate.
        ...
        for old_edge in original_in_edges:
            ...
            if isinstance(old_edge.src, AccessNode):
                ...
                if src_is_singleton:
                    ...
                    inner_state.add_edge(old_edge.src, old_edge.src_conn, load, "_src",
                                         Memlet(data=old_edge.src.data, subset=src_subset))
