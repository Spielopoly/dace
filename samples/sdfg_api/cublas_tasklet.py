...
cublasHandle_t handle;''', language=dc.Language.CPP)
# Initialization code (called in __dace_init())
sdfg.append_init_code('cublasCreate(&handle);', language=dc.Language.CPP)
# Teardown code (called in __dace_exit())
sdfg.append_exit_code('cublasDestroy(handle);', language=dc.Language.CPP)
