...
<script>
    ...
    def add_pgrid(self,
        ...
        self.append_init_code(pgrid.init_code(), language=dtypes.Language.CPP)
        self.append_exit_code(pgrid.exit_code(), language=dtypes.Language.CPP)
    ...
    def add_subarray(self,
        ...
        self.append_init_code(subarray.init_code(), language=dtypes.Language.CPP)
        self.append_exit_code(subarray.exit_code(), language=dtypes.Language.CPP)
    ...
    def add_rdistrarray(self, array_a: str, array_b: str, name: Optional[str] = None) -> str:
        ...
        self.append_init_code(rdistrarray.init_code(self), language=dtypes.Language.CPP)
        self.append_exit_code(rdistrarray.exit_code(self), language=dtypes.Language.CPP)
        return name
