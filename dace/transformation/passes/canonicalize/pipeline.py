...
def _build_stages(unroll_limit: int = DEFAULT_UNROLL_LIMIT,
    ...
    if reduction_to_wcr_map:
        ...
        # LoopToMap outlines the body, trapping the fresh WCR inside the NSDFG. The earlier
        # normalization cannot see it, so normalize once more after inlining and cleanup.
...
def canonicalize(sdfg: SDFG,
    ...
    :param dump_dir: Optional directory for the input and every intermediate stage dump.
