...
the plain rename (passed by value). Direct AccessNode sources inside nested SDFGs follow the same binding rules.
Untraceable bridges must warn, not silently emit nothing.
"""
